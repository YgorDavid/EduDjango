...
- **Sistema de autenticação:** Os usuários podem se registrar e fazer login para acessar recursos exclusivos.
- **Gerenciamento de Cursos:** Os educadores podem criar, editar e gerenciar cursos facilmente.
- **Avaliações e Feedback:** Os alunos podem fazer avaliações e receber feedback construtivo.

## Instalação
1. Clone o repositório:
   ```bash
   git clone https://github.com/YgorDavid/EduDjango.git
